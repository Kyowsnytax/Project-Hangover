          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link px-3" href="about.html"
                ><i class="bi bi-truck"></i> About</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="location.html"
                ><i class="bi bi-geo-alt"></i> Location</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="menu.html"
                ><i class="bi bi-egg-fried"></i> Menu</a
              >
            </li>
            <li class="nav-item" id="navbarOrderLink">
              <a class="nav-link px-3" href="#" id="orderLink"
            ...
            <li class="nav-item" id="navbarAccountLink">
              <a class="nav-link px-3" href="account.html"
                ...
                ><span id="navbarAccountText">Account</span></a
              >
            </li>
          </ul>
        </div>
      ...
      >
        ...
        <div class="footer-section social-section">
          ...
          <ul class="social-links">
            ...
            <li>
              <a
                href="https://www.tiktok.com/search?lang=en&q=intro%20edits&t=1756230180520"
